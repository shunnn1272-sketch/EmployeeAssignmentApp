...
上部メニューの工程をクリックします。
- 工程の新規登録
　追加したい工程名を入力し、追加ボタンをクリック

- 工程の削除
　削除をクリックし、削除したい工程名を選択、削除をクリック

 ### 作業員管理
 上部メニューの作業員をクリックします。
 - 作業員新規登録
   追加をクリックし、名前を入力し、役職を選択、追加をクリック<br>
    ※社員コードは自動で決まります。

 - 作業員削除
   削除をクリックし、社員コード、名前を入力し、削除をクリック

 - 作業員情報編集
   編集をクリックし、社員コードと名前を入力<br>
   1. 習得済み工程を見たい場合は習得済み一覧をクリック<br>
   2. 作業可能工程を追加したい場合は、追加を選択、工程を選択し、追加ボタンをクリック<br>
   3. 作業可能工程を削除したい場合は、削除を選択、工程を選択し、削除ボタンをクリック<br>

 - 作業員一覧
   一覧をクリックすると登録した作業員の一覧を見れます。
